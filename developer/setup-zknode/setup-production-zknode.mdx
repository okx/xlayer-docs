...
X Layer is now available on the Testnet for developers to launch smart contracts, execute transactions, and experiment with the network. This tutorial extends the exploration by allowing developers to launch their own node on the Public Testnet.
...
XLAYER_NODE_STATEDB_DATA_DIR = "./xlayer_testnet_data/statedb"

# PATH WHERE THE POOLDB POSTGRES CONTAINER WILL STORE PERSISTENT DATA
XLAYER_NODE_POOLDB_DATA_DIR = "./xlayer_testnet_data/pooldb"
```
