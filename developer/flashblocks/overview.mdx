...
Flashblocks enables transaction pre-confirmations in ~200ms, drastically reducing user-perceived latency and enabling near-instantaneous user experiences for applications that require real-time interactions like gaming, high-frequency trading, and social apps.
...
Returns the current pending block height.
