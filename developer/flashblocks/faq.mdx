...
Reorgs occur very rarely. It is good practice for applications to handle them appropriately when they do occur. As we collect more operational data, we will provide detailed metrics on reorg frequency and patterns.
