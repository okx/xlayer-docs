# Price feed
[X Layer Oracle](https://www.okx.com/xlayer/oracle "X Layer Oracle") price feeds is the quickest way to connect your smart contracts to the real-world market prices of crypto assets.
...
For example, on X Layer testnet you could create the interface object in the constructor of your contract using the following example:
...
## X Layer testnet Oracle contract address
| Name | Address |
| - | - |
...
The list shown below represents X Layer testnet Oracle price feeds:
