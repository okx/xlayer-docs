...
## Testnet (chain-id: 0xC4, 196 in decimals)
...
Will be available after mainnet launch
# testnet
curl -X POST --data '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}' -H "Content-Type: application/json" https://testrpc.xgon.io
```
## JSON-RPC methods
