...
The next step is to [bridge your assets](/getting-started/user-guide/bridge "bridge your assets") from Ethereum → Xgon. You can use the [Xgon Bridge](https://www.okx.com/xgon/testnet-bridge "Xgon Bridge") to bridge your assets.
