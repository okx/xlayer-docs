...
The next step is to [bridge your assets](/getting-started/user-guide/bridge "bridge your assets") from Ethereum → XGON. You can use the [XGON Bridge](https://www.okx.com/xgon/bridge-test "XGON Bridge") to bridge your assets.
