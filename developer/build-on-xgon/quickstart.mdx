...
<Card mainTitle="Deploy using Hardhat" subTitle='Guide to deploy contract using Hardhat' link="./developer/smart-contract/deploy-using-hardhat"/>
<Card mainTitle="Deploy using Truffle" subTitle='Guide to deploy contract using Truffle' link="./developer/smart-contract/deploy-using-truffle"/>
<Card mainTitle="Deploy using Foundry" subTitle='Guide to deploy contract using Foundry' link="./developer/smart-contract/deploy-using-foundry"/>

## Developer support
If you need help with anything related to Xgon, you can raise your questions on our Discord channel:
1. Join the Xgon Discord server [here](https://discord.gg/okbc "here").
