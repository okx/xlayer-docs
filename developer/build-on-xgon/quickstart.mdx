...
<Card mainTitle="Deploy using Hardhat" subTitle='Guide to deploy contract using Hardhat' link="/developer/smart-contract/deploy-with-hardhat"/>
<Card mainTitle="Deploy using Truffle" subTitle='Guide to deploy contract using Truffle' link="./developer/smart-contract/deploy-with-truffle"/>
<Card mainTitle="Deploy using Foundry" subTitle='Guide to deploy contract using Foundry' link="./developer/smart-contract/deploy-with-foundry"/>
