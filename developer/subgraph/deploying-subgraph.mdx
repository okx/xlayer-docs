...
- Example：https://github.com/okx-subgraph/x1-subgraph-example
...
If you want to query block numbers, you can use <LinkNotWithLangPath text='blocks-subgraph' link='https://www.okx.com/api/v1/x1-testnet/index/subgraphs/name/blocks-subgraph/graphql'/>.
...
## Graph Explorer
Using [Graph Explorer](https://thegraph.com/explorer "Graph Explorer") will help you query data more easily. Take <LinkNotWithLangPath text='x1-faucet-subgraph' link='https://www.okx.com/api/v1/x1-testnet/index/subgraphs/name/x1-test-faucet/graphql' /> as an example:
