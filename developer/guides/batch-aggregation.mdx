...
```
Regarding the `inputSnark` section, please refer to the [**Transaction validation**](/developer/guides/x-layer-protocol/transaction-validation "Transaction validation") chapter for more details.