...
```
Regarding the `inputSnark` section, please refer to the [**Transaction validation**](/developer/learn-more/transaction-validation "Transaction validation") chapter for more details.