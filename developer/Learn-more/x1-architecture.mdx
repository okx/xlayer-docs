...
To get a sense of the complete transaction life cycle on X1, we recommend you to take a look at the [Transactions and data flow](/developer/learn-more/x1-protocol/transactions-n-data-flow "Transactions and data flow") document.
