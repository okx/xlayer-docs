# Websocket endpoints
X1 supports Websocket methods that are compatible with Ethereum, and zkEVM RPC methods for zkEVM.
...
### Others
It also supports Ethereum compatible and zkEVM [RPC methods](/developer/build-on-x1/rpc-endpoints "RPC methods") with websocket.
