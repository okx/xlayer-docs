...
You can connect to the X1 Testnet through the RPC service provider [ZAN Node](https://zan.top/home/node-service/?partner=X1 "ZAN Node") or simply add X1 Testnet to MetaMask through [Chainlist](https://chainlist.org/chain/195 "Chainlist")
