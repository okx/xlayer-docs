...
X Layer is a zkEVM Layer 2 network built on Ethereum, powered by [Polygon CDK](https://wiki.polygon.technology/docs/cdk/ "Polygon CDK") - a zkEVM stack for building Ethereum L2 scaling solutions.
...
<Tip title="Note">Mainnet network info will be updated after X Layer     is live on Mainnet.</Tip>
...
1. Join the X Layer Discord server [here](https://discord.gg/x1-network "here").
