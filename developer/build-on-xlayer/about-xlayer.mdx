...
X Layer adopts the validium mode with a dedicated committee of sequencers, delivering a high‑performance L2 scaling solution. Following the PP upgrade on August 5, 2025, X Layer now achieves up to 5,000 TPS with negligible gas fees through seamless AggLayer integration, while maintaining full interoperability with other Polygon chains.
