...
| 2.3 | Data Persistence | The `L2BridgeSyncer` and `L1InfoTreeSyncer` persist chain data and L1 info updates needed. |
...
| 3.4 | L1 Finality | After **L1 verification**, withdrawals and messages achieve L1 finality. |
