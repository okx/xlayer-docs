...
| 2.2 | Block Generation | The Sequencer continues to generate blocks (with **2-second finality**). |
| 2.3 | Data Persistence | The `L2BridgeSyncer` and `L1InfoTreeSyncer` persist chain data and L1 info updates needed for the Proof of Pruning (PP). |
