...
In this tutorial, we explain step-by-step how to create, compile and deploy a simple smart contract on the Xgon testnet using Hardhat.
...
In order to connect to the Xgon network, we need to configure the corresponding network.
...
```
$ npx hardhat run scripts/deploy.js --network Xgon
