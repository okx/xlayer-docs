...
2. Navigate to [OKX explorer](https://www.okx.com/explorer/ "OKX explorer") and select **Xgon testnet**. Once you are on the right network, paste the contract address into the search box.
