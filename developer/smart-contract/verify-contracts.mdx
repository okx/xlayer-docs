...
2. Navigate to [OKLink](https://www.oklink.com/ "OKLink") and select **XGON testnet**. Once you are on the right network, paste the contract address into the search box.
