        ...
        customChains: [
            {
                ...
                urls: {
                    apiURL: "https://www.oklink.com/api/explorer/v1/contract/verify/async/api/xlayer_test", #or https://www.oklink.com/api/explorer/v1/contract/verify/async/api/xlayer for mainnet
