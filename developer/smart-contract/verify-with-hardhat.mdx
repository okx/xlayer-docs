        ...
        customChains: [
            {
                ...
                urls: {
                    apiURL: "https://www.oklink.com/api/explorer/v1/contract/verify/async/api/XLAYER_TESTNET", //or https://www.oklink.com/api/v5/explorer/contract/verify-source-code-plugin/XLAYER for mainnet
