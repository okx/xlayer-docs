...
2. Navigate to [OKX Explorer](https://www.okx.com/explorer/ "OKX Explorer") and select **X1 testnet**. Once you are on the right network, paste the contract address into the search box.
