...
- **Consensus**: X Layer PoE contract （[ZkEVM.sol](https://github.com/okx/xlayer-contracts/blob/release/v0.1.0/contracts/PolygonZkEVM.sol "ZkEVM.sol")）
- **Sequencer**: Trusted
- **Gas token**: OKB

![X Layer Architecture](./img/xlayer-architecture.png)
