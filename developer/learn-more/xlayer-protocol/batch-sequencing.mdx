...
<Tip title="Note">Any change in the batch chain that causes all future accumulated input hashes to be incorrect, would indicate a lack of integrity in the resulting layer 2 state.</Tip>
