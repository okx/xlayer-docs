...
- Bridge smart contract ([ZkEVMBridge.sol](https://github.com/okx/x1-contracts/blob/release/v0.1.0/contracts/PolygonZkEVMBridge.sol "ZkEVMBridge.sol"))
- Global Exit Root Manager ([ZkEVMGlobalExitRoot.sol](https://github.com/okx/x1-contracts/blob/release/v0.1.0/contracts/PolygonZkEVMGlobalExitRoot.sol "ZkEVMGlobalExitRoot.sol"))
- Consensus contract ([ZkEVM.sol](https://github.com/okx/x1-contracts/blob/release/v0.1.0/contracts/PolygonZkEVM.sol "ZkEVM.sol"))
...
## Consensus contract
The `ZkEVM.sol` smart contract is the consensus algorithm used in X1. It is located in L1 for batch verification purposes.
