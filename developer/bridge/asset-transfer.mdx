...
<Tip title="Note">There are two Global Exit Root manager SCs: one deployed in L1, while the other is deployed in L2.
Their Solidity code files are; ZkEVMGlobalExitRoot.sol, and ZkEVMGlobalExitRootL2.sol, respectively.</Tip>
