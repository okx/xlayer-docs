...
<Tip title="Note">There are two bridge smart contracts: ‌one deployed in L1, while the other is deployed in layer 2, both using the same ZkEVMBridge.sol code file, but using different parameters for the interaction.</Tip>
