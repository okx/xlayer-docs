...
<Card mainTitle="Xgon bridege smart contracts" subTitle='Smart contracts for asset transfer' link="./asset-transfer"/>
...
It doesn't include the interaction between the consensus contract and the sequencer, which is discussed in more detail in earlier subsections of this documentation, particularly in the [consensus contract](https://github.com/okx/Xgon-contracts/blob/release/v0.1.0/contracts/PolygonZkEVM.sol "consensus contract") section.</Tip>