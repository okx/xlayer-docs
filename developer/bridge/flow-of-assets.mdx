...
<Card mainTitle="Xgon bridege smart contracts" subTitle='Smart contracts for asset transfer' link="/developer/bridge/asset-transfer"/>
...
It doesn't include the interaction between the consensus contract and the sequencer, which is discussed in more detail in earlier subsections of this documentation, particularly in the [consensus contract](URL "consensus contract") section.</Tip>