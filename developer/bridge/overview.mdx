...
The use of two distinct **Global Exit Root managers** for layer 1 and layer 2, as well as separate logic for Bridge smart contract and each of these **Global Exit Root managers**, allows for extensive network interoperability.
Meanwhile, all asset transfers can be validated by any layer 1 and layer 2 nodes due to data availability.
...
<Card mainTitle="Flow of Assets" subTitle='Mechanics of sending message/assets across layer 1 and layer 2' link="/developer/bridge/flow-of-assets"/>