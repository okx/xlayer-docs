...
For more detailed information, you can explore the X Layer [architecture](/developer/about-x-layer/x-layer-architecture "architecture") in the developer's section of the documentations>.
