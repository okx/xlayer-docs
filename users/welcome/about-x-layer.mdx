...
For more detailed information, you can explore the X Layer [architecture](/developer/guides/x-layer-architecture "architecture") in the developer's section of the documentations>.
