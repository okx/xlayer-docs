...
1. Enter the [Xgon bridge testnet page](https://www.okx.com/xgon/testnet-bridge "Xgon bridge testnet page"), then select **Sepolia** (left) and **Xgon testnet** (right) as the two bridging directions, as shown below:
