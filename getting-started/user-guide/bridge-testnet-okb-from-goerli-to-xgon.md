# Bridge Testnet OKB from Goerli to Xgon
...
<Tip title="Note">
Please ensure that your wallet contains enough ETH (Sepolia ETH) for gas fees on the Sepolia network. You can also use the Xgon bridge to bridge ETH to the Xgon testnet.
</Tip>
...
![Get OKB in Sepolia](./img/{name}.png)
