...
|Token symbol|OKB|
|Block explorer URL|https://www.okx.com/explorer/xgon-test|
...
### Adding network in OKX Wallet
1. Unlock your OKX Wallet and click the **Settings** icon in the upper right corner:
![OKX wallet settings](./img/{name}.png)
2. Activate the Custom network switch and manually configure the network information:
![Turn on the "custom network" switch](./img/{name}.png)
3. Find the Xgon testnet item and click to switch to that network:
![Choose Xgon testnet](./img/{name}.png)
