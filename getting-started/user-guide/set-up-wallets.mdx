...
![Approve X Layer testnet](./img/approve-xlayer-testnet.png)
...
6. Populate the network information for the X Layer testnet as described above and click the Save button:

![Input network info](./img/input-network-info.png)

You can now view the successfully configured X Layer testnet network within your wallet!

### Switching to X Layer network in OKX Wallet
...
2. Click **Testnet tap** and find the X Layer testnet. Click the bottom to switch to X Layer testnet.

![OKX wallet X Layer testnet](./img/okxwallet-xlayer-testnet.png)

You are now on the X Layer testnet. Head to the X Layer faucet to claim test tokens and embark on your journey into the world of Web3!

### Switching to X Layer network in Particle Wallet (Particle Network)
...
2. Enable **Test Network**, search for **X Layer Testnet**, and click **X Layer Testnet**.

![Particle Wallet X Layer testnet](./img/particle-wallet-xlayer.png)

You're now connected to the X Layer testnet on Particle!