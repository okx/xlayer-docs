...
|2|Particle Network|Non-custodial|https://particle.network|Mobile, browser, embedded|Multi-chain|
...
1. Log into Particle Wallet, either through the [web app](https://wallet.particle.network) or mobile app(https://apps.apple.com/us/app/particle-crypto-wallet/id1632425771), and navigate to the network selection menu in the upper left corner.

![Particle Wallet network selection](./img/particle-wallet-network.png)

2. Enable "Test Network" and click "X1 testnet."
