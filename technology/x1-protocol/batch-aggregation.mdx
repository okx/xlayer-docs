...
```
Regarding the `inputSnark` section, please refer to the [**Transaction validation**](/technology/x1-protocol/transaction-validation "Transaction validation") chapter for more details.