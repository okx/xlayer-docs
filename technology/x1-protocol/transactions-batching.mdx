...
### MinForcedTimestamp
If a batch is a so-called forced batch, this parameter must be greater than zero. Censorship is countered by using forced batches. You can learn more about this in the next section - [Batch Sequencing](/technology/x1-protocol/batch-sequencing "Batch Sequencing").